      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-indigo-600 via-emerald-500 to-amber-500 p-[1px] shadow-lg shadow-indigo-500/20">
              <div className="flex h-full w-full items-center justify-center rounded-[11px] bg-slate-950">
                <Bot className="h-5 w-5 text-indigo-400" />
              </div>
            </div>
            <div>
              <span className="font-bold tracking-tight text-white text-base gradient-text">
                Autonomous SE
              </span>
          ...
          {/* Selected Repo Badge */}
          {selectedRepo && (
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-900/80 border border-white/10 text-xs text-slate-300">
          ...
          {user ? (
            <div className="flex items-center gap-3 pl-2 border-l border-white/10">
              ...
              <div className="hidden sm:block text-left">
                ...
                <span className="text-[10px] font-mono text-indigo-400 capitalize">{user.role}</span>
              </div>
              <button
                onClick={logout}
                title="Sign Out"
            ...
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-medium transition-all"
            >
